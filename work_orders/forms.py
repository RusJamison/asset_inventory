...
class ScheduledWorkOrderForm(forms.ModelForm):
    work_order_num = forms.IntegerField(widget=forms.TextInput(
        attrs={'class': 'form-control'})
    )
    next_scheduled_action_date = forms.DateField(widget=forms.DateInput(
        attrs={'type': 'date'})
    )
    last_serviced_at = forms.DateField(widget=forms.DateInput(
        attrs={'type': 'date'})
    )
...
class UnScheduleWorkOrderForm(forms.ModelForm):
    ...
    date_of_update = forms.DateField(
    ...
    work_order_report = forms.FileField(widget=forms.FileInput(),
                                        required=False
                                        )
